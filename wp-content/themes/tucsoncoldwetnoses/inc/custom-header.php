...
function tucsoncoldwetnoses_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'tucsoncoldwetnoses_custom_header_args', array(
		...
		'wp-head-callback'       => 'tucsoncoldwetnoses_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'tucsoncoldwetnoses_custom_header_setup' );

if ( ! function_exists( 'tucsoncoldwetnoses_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see tucsoncoldwetnoses_custom_header_setup().
 */
function tucsoncoldwetnoses_header_style() {
